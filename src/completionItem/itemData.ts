  ...
  "t-chat-actionbar": {
    ...
    attrs: [
      ...
      },
      {
        ...
        default: "-",
        description:
          "【实验】长按触发点的位置信息，用于定位 popover。TS 类型：`{pageX: number; pageY: number; clientX: number; clientY: number; x: number; y: number}`",
        required: "N",
      },
      {
        name: "placement",
        type: "String",
        default: "start",
        description: "【实验】操作栏位置。可选项：start/end/space-around/space-between/longpress",
        required: "N",
      },
    ],
  },
  ...
  "t-button": {
    attrs: [
      ...
      },
      {
        ...
        type: "String",
        default: "-",
        description: "从消息小程序入口打开小程序的路径，默认为聊天工具启动路径",
        required: "N",
      },
      {
        name: "ghost",
      ...
      },
      {
        ...
        default: "-",
        description:
          "指定返回用户信息的语言，zh_CN 简体中文，zh_TW 繁体中文，en 英文。<br />具体释义：<br />`en` 英文；<br />`zh_CN` 简体中文；<br />`zh_TW` 繁体中文。<br />[小程序官方文档](https://developers.weixin.qq.com/miniprogram/dev/component/button.html)。可选项：en/zh_CN/zh_TW",
        required: "N",
      },
      {
        name: "loading",
      ...
      },
      {
        ...
        type: "String",
        default: "-",
        description: '会话来源，open-type="contact"时有效，长度不超过 1024 个字符',
        required: "N",
      },
      {
        name: "shape",
  ...
  "t-drawer": {
    attrs: [
      ...
      },
      {
        ...
        default: "{}",
        description:
          "遮罩层的属性，透传至 overlay。TS 类型：`OverlayProps`，[Overlay API Documents](./overlay?tab=api)。[详细类型定义](https://github.com/Tencent/tdesign-miniprogram/blob/develop/packages/components/drawer/type.ts)",
        required: "N",
      },
      {
        name: "placement",
  ...
  "t-calendar": {
    attrs: [
      ...
      },
      {
        ...
        default: "none",
        description:
          "切换模式。 `none` 表示水平方向平铺展示所有月份； `month` 表示支持按月切换， `year-month` 表示既按年切换，也支持按月切换。可选项：none/month/year-month",
        required: "N",
      },
      {
        name: "title",
  ...
  "t-date-time-picker": {
    attrs: [
      ...
      },
      {
        ...
        default: "-",
        description:
          "格式化标签。TS 类型：`(option: DateTimePickerColumnItem, columnIndex: number) => DateTimePickerColumnItem`",
        required: "N",
      },
      {
        name: "header",
  ...
  "t-input": {
    attrs: [
      ...
      },
      {
        ...
        default: "done",
        description:
          "设置键盘右下角按钮的文字，仅在type='text'时生效。<br />具体释义：<br />`send` 右下角按钮为“发送”；<br />`search` 右下角按钮为“搜索”；<br />`next` 右下角按钮为“下一个”；<br />`go` 右下角按钮为“前往”；<br />`done` 右下角按钮为“完成”。<br />[小程序官方文档](https://developers.weixin.qq.com/miniprogram/dev/component/input.html)。可选项：send/search/next/go/done",
        required: "N",
      },
      {
        name: "cursor",
  ...
  "t-radio": {
    attrs: [
      ...
      },
      {
        ...
        default: "'circle'",
        description:
          "自定义选中图标和非选中图标。使用 Array 时表示：[选中态图标，非选中态图标]。使用 String 时，值为 circle 表示填充型图标、值为 line 表示描边型图标、值为 dot 表示圆点图标，值为 slot 时使用插槽。TS 类型：'circle' | 'line' | 'dot' | Array<string>",
        required: "N",
      },
      {
        name: "label",
      ...
      },
      {
        ...
        default: "-",
        description:
          "复选框和内容相对位置。优先级高于 RadioGroup.placement。Radio 单独存在时，默认值为 left。如果父组件存在 RadioGroup，默认值便由 RadioGroup.placement 决定。可选项：left/right",
        required: "N",
      },
      {
        name: "readonly",
  ...
  "t-radio-group": {
    attrs: [
      ...
      },
      {
        ...
        default: "-",
        description:
          "单选组件按钮形式。RadioOption 数据类型为 string 或 number 时，表示 label 和 value 值相同。TS 类型：Array<RadioOption> type RadioOption = string | number | RadioOptionObj interface RadioOptionObj { label?: string; value?: string | number; readonly?: boolean; disabled?: boolean; allowUncheck?: boolean; }。",
        required: "N",
      },
      {
        name: "placement",
  ...
  "t-rate": {
    attrs: [
      ...
      },
      {
        ...
        default: "[]",
        description:
          "评分等级对应的辅助文字。组件内置默认值为：['极差', '失望', '一般', '满意', '惊喜']。自定义值示例：['1分', '2分', '3分', '4分', '5分']。TS 类型：`Array<string>`",
        required: "N",
      },
      {
        name: "value",
  ...
  "t-search": {
    attrs: [
      ...
      },
      {
        ...
        type: "String",
        default: "'search'",
        description: "左侧图标。如果需要使用 `Slot` 进行自定义，必须将该值设置为假值",
        required: "N",
      },
      {
        name: "maxcharacter",
  ...
  "t-slider": {
    attrs: [
      ...
      },
      {
        ...
        default: "false",
        description:
          "滑块当前值文本。<br />值为 true 显示默认文案；值为 false 不显示滑块当前值文本；<br />值为 `${value}%` 则表示组件会根据占位符渲染文案；<br />值类型为函数时，参数 `value` 标识滑块值，参数 `position=start` 表示范围滑块的起始值，参数 `position=end` 表示范围滑块的终点值。TS 类型：`string | boolean`",
        required: "N",
      },
      {
        name: "marks",
        ...
        default: "{}",
        description:
          "刻度标记，示例：`[0, 10, 40, 200]` 或者 `{ 5:  '5¥', 10: '10%' }`。TS 类型：`Record<number, string> | Array<number>`",
        required: "N",
      },
      {
        name: "max",
  ...
  "t-switch": {
    attrs: [
      ...
      },
      {
        ...
        default: "[true, false]",
        description:
          "用于自定义开关的值，[打开时的值，关闭时的值]。默认为 [true, false]。示例：[1, 0]、['open', 'close']。TS 类型：`Array<SwitchValue>`",
        required: "N",
      },
      {
        name: "disabled",
  ...
  "t-upload": {
    attrs: [
      ...
      },
      {
        ...
        default: "-",
        description:
          "upload组件每行上传图片列数以及图片的宽度和高度。TS 类型：`{column?: number;  width?: number; height?: number;}`",
        required: "N",
      },
      {
        name: "gutter",
  ...
  "t-image": {
    attrs: [
      ...
      },
      {
        ...
        default: "scaleToFill",
        description:
          "图片裁剪、缩放的模式；[小程序官方文档](https://developers.weixin.qq.com/miniprogram/dev/component/image.html)。可选项：scaleToFill/aspectFit/aspectFill/widthFix/heightFix/top/bottom/center/left/right/top left/top right/bottom left/bottom right",
        required: "N",
      },
      {
        name: "shape",
  ...
  "t-skeleton": {
    attrs: [
      ...
      },
      {
        ...
        default: "none",
        description:
          "动画效果，有「渐变加载动画」和「闪烁加载动画」两种。值为 'none' 则表示没有动画。可选项：gradient/flashed/none",
        required: "N",
      },
      {
        name: "delay",
  ...
  "t-swiper": {
    attrs: [
      ...
      },
      {
        ...
        default: "default",
        description:
          "`0.32.0`。指定 swiper 切换缓动动画类型。可选项：default/linear/easeInCubic/easeOutCubic/easeInOutCubic",
        required: "N",
      },
      {
        name: "height",
      ...
      },
      {
        ...
        default: "false",
        description:
          "`0.32.0`。当 swiper-item 的个数大于等于 2，关闭 circular 并且开启 previous-margin 或 next-margin 的时候，可以指定这个边距是否应用到第一个、最后一个元素",
        required: "N",
      },
    ],
  },
  ...
  "t-watermark": {
    attrs: [
      ...
      },
      {
        ...
        default: "-",
        description:
          "水印所覆盖的内容节点。[通用类型定义](https://github.com/Tencent/tdesign-miniprogram/blob/develop/packages/components/common/common.ts)",
        required: "N",
      },
      {
        name: "height",
      ...
      },
      {
        ...
        default: "rectangular",
        description:
          "水印的布局方式，rectangular：矩形，即横平竖直的水印；hexagonal：六边形，即错位的水印。可选项：rectangular/hexagonal",
        required: "N",
      },
      {
        name: "line-space",
      ...
      },
      {
        ...
        default: "-",
        description:
          "水印在画布上绘制的水平和垂直偏移量，正常情况下水印绘制在中间位置，即 `offset = [gapX / 2, gapY / 2]`。TS 类型：`Array<number>`",
        required: "N",
      },
      {
        name: "removable",
  ...
  "t-action-sheet": {
    attrs: [
      ...
      },
      {
        ...
        default: "-",
        description:
          "必需。菜单项。TS 类型：`Array<string | ActionSheetItem>` `interface ActionSheetItem { label: string; description?: string; color?: string; disabled?: boolean; icon?: string | object; suffixIcon?: string | object }`。[详细类型定义](https://github.com/Tencent/tdesign-miniprogram/blob/develop/packages/components/action-sheet/type.ts)",
        required: "N",
      },
      {
        name: "popup-props",
  ...
  "t-guide": {
    attrs: [
      ...
      },
      {
        ...
        default: "-",
        description:
          "用于定义每个步骤的内容，包括高亮的节点、相对位置和具体的文案内容等。。TS 类型：`Array<GuideStep>`",
        required: "N",
      },
      {
        name: "using-custom-navbar",
  ...
  "t-pull-down-refresh": {
    attrs: [
      ...
      },
      {
        ...
        default: "true",
        description:
          "`1.1.5`。iOS点击顶部状态栏、安卓双击标题栏时，滚动条返回顶部，只支持竖向。自 2.27.3 版本开始，若非显式设置为 false，则在显示尺寸大于屏幕 90% 时自动开启",
        required: "N",
      },
      {
        name: "enable-passive",
